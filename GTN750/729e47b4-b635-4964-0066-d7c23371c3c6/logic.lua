-- Select whether this unit is in position 1 or two.  If you need two GTN750s clone this instrument, rename it, and change the variable 
...
button_add( nil,"home_but.png", 765,22,55,40, home_click)
...
button_add(nil,"direct_but.png", 765,550,55,40, direct_click)
...
local knob_rot = 6
coarse_knob = dial_add( "fms_outer.png", 735,685,110,110, dial_coarse)
...
fine_knob = dial_add( "fms_inner.png", 760,710,60,60, dial_fine)
...
button_add(  nil,nil, 780,725,20,20, click_fms)
